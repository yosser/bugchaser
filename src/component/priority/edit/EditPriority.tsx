...
export const EditPriority: React.FC<EditPriorityProps> = ({ priority, onClose }) => {
    const [formData, setFormData] = useState({
        name: priority.name,
        description: priority.description || "", // Default blue color if no color is set
        value: priority.value,
        colour: priority.colour,
        textColour: priority.textColour,
    ...
    return (
        <div className="fixed inset-0 bg-gray-500/75 flex items-center justify-center">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                <h2 className="text-2xl font-semibold mb-6">Edit Priority</h2>
