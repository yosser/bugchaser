...
export const AddTicketType: React.FC<AddTicketTypeProps> = ({ onClose }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error("Failed to create ticketType:", error);
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-gray-500/75 flex items-center justify-center">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                <h2 className="text-2xl font-semibold mb-6">Add New TicketType</h2>
