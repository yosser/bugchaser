...
export const EditQualification: React.FC<EditQualificationProps> = ({ qualification, onClose }) => {
    const [formData, setFormData] = useState({
        name: qualification.name,
        description: qualification.description || "", // Default blue color if no color is set
    });
    ...
    return (
        <div className="fixed inset-0 bg-gray-500/75 flex items-center justify-center">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                <h2 className="text-2xl font-semibold mb-6">Edit Qualification</h2>
